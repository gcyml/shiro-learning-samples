...
//        myShiroRealm.setCredentialsMatcher(retryLimitCredentialsMatcher());
    ...
    public HashedCredentialsMatcher credentialsMatcher() {
    	RetryLimitHashCredentialsMatcher retryLimithashedCredentialsMatcher = new RetryLimitHashCredentialsMatcher(ehCacheManager());
        // 采用MD5方式加密
    	retryLimithashedCredentialsMatcher.setHashAlgorithmName("MD5");
        // 设置加密次数
    	retryLimithashedCredentialsMatcher.setHashIterations(1024);
        // 设置密码重试次数
    	retryLimithashedCredentialsMatcher.setMaxRetryNum(5);
